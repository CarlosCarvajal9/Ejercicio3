...
public class Guardar extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{//se usa en donde puede producir un error para no tronar la app
            OutputStreamWriter archivo= new OutputStreamWriter( new FileOutputStream(jTextField1.getText()));//nombrar
            
            archivo.write( puntero.jEditorPane1.getText());
            archivo.close();
            
            JOptionPane.showMessageDialog(this,"Se guardo correctamente el archvio");
